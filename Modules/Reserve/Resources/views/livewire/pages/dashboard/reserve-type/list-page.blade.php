    ...
    <div class="col-lg-12">
        <div class="card-box">
            <div class="card-block">
                ...
                <a class="btn btn-primary pull-right" href="{{ route('reserve-types.create') }}">افزودن نوع رزرو جدید</a>
                ...
                <table class="table table-hover">
                    ...
                    @foreach ($items as $item)
                        <tr>
                            ...
                            <td>
                                <div class="buttons ">
                                    <a href="{{ route('reserve-types.edit' , $item->id) }}"
...
@push('StackScript')
    ...
    @include('livewire.bulk_actions.bulk_actions_js', ['items' => $items, 'model' => \Modules\Reserve\Entities\ReserveType::class])
@endpush
