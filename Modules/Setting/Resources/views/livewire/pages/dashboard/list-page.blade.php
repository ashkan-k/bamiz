        ...
        <div class="card-box">
            <div class="card-block">
                ...
                <a class="btn btn-primary pull-right"
                   href="{{ route('settings.create') }}">افزودن
                    تنطیمات جدید</a>
                ...
                <table class="table table-hover">
                    ...
                    @foreach ($items as $item)
                        <tr>
                            ...
                            <td>{{$item->key}}</td>
                            <td title="{{ $item->value }}">{{\Illuminate\Support\Str::limit($item->value, 25)}}</td>
...
@push('StackScript')
    ...
    @include('livewire.bulk_actions.bulk_actions_js', ['items' => $items, 'model' => \Modules\Setting\Entities\Setting::class])
@endpush
