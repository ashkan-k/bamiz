    ...
    <div class="col-lg-12">
        <div class="card-box">
            <div class="card-block">
                ...
                <a class="btn btn-primary pull-right" href="{{ route('cities.create') }}">افزودن شهر جدید</a>
...
@push('StackScript')
    ...
    @include('livewire.bulk_actions.bulk_actions_js', ['items' => $items, 'model' => \Modules\Common\Entities\City::class])
@endpush
