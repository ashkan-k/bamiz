                ...
                <table class="table table-hover">
                    ...
                    @foreach ($items as $item)
                        <tr>
                            ...
                            <td>
                                <div class="buttons ">
                                    <a href="{{ route('hotel-rooms.edit' , $item->id) }}?place_id={{ $place_id }}"
...
@push('StackScript')
    ...
    @include('livewire.bulk_actions.bulk_actions_js', ['items' => $items, 'model' => \Modules\Place\Entities\HotelRoom::class])
@endpush
