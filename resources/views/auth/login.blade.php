                    ...
                    <div class="col-12">
                        <form method="POST" action="{{ route('login') }}?next={{ request('next') }}" id="id_frm">
                            ...
                            <div class="clearfix add_bottom_30">
                                ...
                                <div class="float-right mt-1"><a id="forgot" href="{{ route('reset_password') }}">رمز
                                        عبور خود را فراموش کرده
                                        اید؟</a></div>
                            </div>

                            <a onclick="$('#id_frm').submit()" class="btn_1 rounded full-width">ورود</a>
                            <div class="text-center add_top_10">حساب کاربری ندارید؟! <strong><a
