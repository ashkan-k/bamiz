...
{{--                    class="badge bg-primary pull-right">3</span></a>--}}
                    ...
                    <ul class="media-list">
                        <li class="media notification-message">
                            <a href="activities.html">
                                ...
                                <div class="media-body">
                                    <p class="noti-details"><span class="noti-title">امین صفرپور</span> افزودن کار جدید
                                        <span class="noti-title">رزرو وقت بیمار</span></p>
                        ...
                        <li class="media notification-message">
                            <a href="activities.html">
                                ...
                                <div class="media-body">
                                    <p class="noti-details"><span class="noti-title">برناردو گالوویز</span> نام کار را
                                        تغییر داد <span class="noti-title">رزرو روزانه با دروازه پرداخت</span></p>
                        ...
                        <li class="media notification-message">
                            <a href="activities.html">
                                ...
                                <div class="media-body">
                                    <p class="noti-details"><span class="noti-title">برناردو گالوویز</span> افزود <span
                                            class="noti-title">امین صفرپور</span> و <span
                                            class="noti-title">کلر مپس</span>برای پروژه <span class="noti-title">دکتر ماژول موجود</span>
                                    </p>
                        ...
                        <li class="media notification-message">
                            <a href="activities.html">
                                ...
                                <div class="media-body">
                                    <p class="noti-details"><span class="noti-title">برناردو گالوویز</span> تکمیل کار
                                        <span class="noti-title">کنفرانس ویدیویی بیمار و دکتر</span></p>
                        ...
                        <li class="media notification-message">
                            <a href="activities.html">
                                ...
                                <div class="media-body">
                                    <p class="noti-details"><span class="noti-title">برناردو گالوویز</span> افزودن کار
                                        جدید <span class="noti-title">ماژول چت خصوصی</span></p>
        ...
        <li class="dropdown hidden-xs">
            <a href="javascript:;" id="open_msg_box" class="hasnotifications"><i class="fa fa-comment-o"></i> <span
                    class="badge bg-primary pull-right">{{ $not_answered_tickets->count() }}</span></a>
        </li>
        <li class="dropdown">
            <a href="profile.html" class="dropdown-toggle user-link" data-toggle="dropdown" title="Admin">
                ...
                <span class="user-img"><img class="img-circle"
                                            src="{{ auth()->user()->avatar ?   auth()->user()->avatar  :  "data:image/jpeg;base64," }}"
                                            width="40" alt="Admin">
							<span class="status online"></span></span>
